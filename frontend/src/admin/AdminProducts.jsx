...
function AdminProducts() {
  ...
  const { data, isLoading, error, refetch } = useAdminAllProductesQuery(
    ...
    <div className="p-6 space-y-6 overflow-y-auto">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Manage platform products</p>
        </div>
          ...
          {[...Array(totalPages)].map((_, i) => {
            ...
            return (
              <button
                ...
                ${
                  page === pageNumber ? "bg-orange-500 text-white" : "bg-white"
                }`}
              >
                {pageNumber}
              </button>
