...
import { useAdminLogoutMutation } from "../redux/api/admin";
import { adminLogout } from "../redux/features/admin/adminauthSlice";
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8">
          ...
          <div className="text-right hidden sm:block">
            <p className="text-xl font-bold text-gray-800">{adminInfo?.name}</p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <img
                src={`https://ui-avatars.com/api/?name=${adminInfo?.name}&background=f97316&color=fff`}
