...
import { useDeleteProductMutation, useGetSpecificProductQuery, useToggleProductStatusMutation } from "../redux/api/products";
...
function SellerProductDetailsPage() {
    ...
    const [ToggleProduct, { isLoading: ToggleProduct_isLoading }] = useToggleProductStatusMutation();
                        ...
                        <div className="lg:w-1/2 flex flex-col">
                            ...
                            <div className="flex items-center gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    >
                                        {product?.isActive === null ? "Null" : product?.isActive ? "ACTIVE" : "INACTIVE"}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-4 mt-auto">
                                ...
                                >
                                    <Trash2 size={18} /> {delete_isLoading ? "Loading..." : "Delete"}
                                </button>
                                ...
                                >
                                    <Power size={18} />
                                    {ToggleProduct_isLoading ? "Loading..." : product?.isActive
                                        ? "Deactivate"
                                        : "Activate"}
                                </button>
                            </div>
